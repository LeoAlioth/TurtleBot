...
class The_Ring:
    def __init__(self):
        ...
        self.alreadyFound = list(self.allPointsMap)
        #self.publishExisting();
    ...
    def play_sound(self):
        ...
        s3 = soundhandle.voiceSound("circle found!")
        s3.play()
        rospy.sleep()
        s3.stop()
        #############
   ...
   # def publishExisting(self):
   #     pass
        # for circle in self.alreadyFound:
        #     x, y, z = circle
